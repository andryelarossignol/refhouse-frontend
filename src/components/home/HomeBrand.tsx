...
export function HomeBrand({ inverted = false }: HomeBrandProps) {
  return (
    <div className={`home-brand ${inverted ? 'home-brand-inverted' : ''}`} aria-label="RefHouse">
      <svg className="home-brand-mark" viewBox="0 0 132 98" role="img" aria-hidden="true">
      ...
      <span className="home-brand-wordmark">RefHouse</span>
    </div>
  )
}
